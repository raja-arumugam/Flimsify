...
class ActorImagesAdapter(
    ...
    RecyclerView.Adapter<ActorImagesAdapter.MyViewHolder>() {

    private lateinit var binding: ItemNowPlayingLayoutBinding
    private var listCount: ArrayList<Int> = ArrayList()
    var onClick: (List<BackdropImages>, Int, Boolean) -> Unit =
        { param: List<BackdropImages>, i: Int, j: Boolean -> }
    ...
    inner class MyViewHolder(val binding: ItemNowPlayingLayoutBinding) :
        ...
        fun bind(item: BackdropImages) {
            ...
            binding.root.setOnClickListener {
                onClick(list, absoluteAdapterPosition, false)
            }
