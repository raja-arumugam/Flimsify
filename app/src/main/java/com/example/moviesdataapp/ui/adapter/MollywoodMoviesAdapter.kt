...
class MollywoodMoviesAdapter(val context: Context, val list: List<MollyWoodMoviesList>) :
    RecyclerView.Adapter<MollywoodMoviesAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MollywoodMoviesAdapter.MyViewHolder {
    ...
    inner class MyViewHolder(val binding: ItemGenresMoviesListLayoutBinding) :
        ...
        fun bind(item: MollyWoodMoviesList) {
