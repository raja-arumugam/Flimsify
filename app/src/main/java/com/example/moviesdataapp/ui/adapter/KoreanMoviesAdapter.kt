...
class KoreanMoviesAdapter(val context: Context, val list: List<KoreanMoviesList>) :
    RecyclerView.Adapter<KoreanMoviesAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): KoreanMoviesAdapter.MyViewHolder {
    ...
    inner class MyViewHolder(val binding: ItemGenresMoviesListLayoutBinding) :
        ...
        fun bind(item: KoreanMoviesList) {
